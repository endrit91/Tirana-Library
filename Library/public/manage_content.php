...
<?php
echo navigation($current_menu,$current_page,false); // vendosim keto argumenta sepse keto jane te definuara me siper
?>
<br>
...
<?php 
	...
	echo show_pages_by_menu($current_menu,$current_page,false);
...
<?php
		...
		echo htmlentities($current_page["img_source"]). "<br>";
		?>
...
<a href="delete_page.php?pages=<?php echo urlencode($current_page["id"]); ?>"> Delete Page</a>
